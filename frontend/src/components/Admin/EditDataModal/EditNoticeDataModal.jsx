...
export const EditNoticeDataModal = ({ path }) => {
  ...
  async function editNotice(formData) {
              ...
              >
                ...
                <FieldStyled>
                  ...
                  <Input
                    ...
                    name="category"
                    placeholder={
                      values.category === '' ? 'Pet category' : values.category
                    }
                ...
                <FieldStyled>
                  ...
                  <Input
                    ...
                    name="typeofpet"
                    placeholder={
                      values.typeofpet === '' ? 'Type of pet' : values.typeofpet
                    }
                ...
                <FieldStyled>
                  ...
                  <Input
                    ...
                    id="size"
                    name="size"
                    placeholder={values.size === '' ? 'Pet size' : values.size}
